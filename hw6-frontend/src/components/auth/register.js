        ...
        <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center">
            ...
            <form  id="registration_form" onSubmit={(e)=>e.preventDefault()}>
                ...
                <div className="form-group row">
                    ...
                    <div className="col-sm-6">
                        <input className="form-control" id="password" type="password" ref={(node) => info.pw = node } placeholder="password" required/>
                    </div>
                </div>
                <div className="form-group row">
                    <label className="col-sm-3 form-control-label">Confirmation</label>
                    <div className="col-sm-6">
                        <input className="form-control" id="pwconf" type="password" ref={(node) => info.pwconf = node } placeholder="password confirmation" required/>
                    </div>
                </div>
                <div className="form-group row">
